...
ADMINS = [("""Koonal Bharadwaj""", "koonalb@gmail.com")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Roon API",
    "DESCRIPTION": "Documentation of API endpoints of Roon-API",
    "VERSION": "1.0.0",
    "SERVE_PERMISSIONS": ["rest_framework.permissions.IsAdminUser"],
}

# Fields that API users aren't allowed to manually update.
...
SEARCH_FILTERS = ['page', 'per_page', 'order_by', 'format', 'include_inactive', 'operator']

# LOGS ANONYMIZATION CONFIGURATION
# ------------------------------------------------------------------------------
# Fields that are anonymized in logs
ANONYMIZE_API_VALUES = [
    "password",
    "mfa",
    "key",
    "vendor",
...
LOGGING = {
    ...
    "formatters": {
        "request": {
            "()": "utility.logging.formatters.RequestLogFormatter",
            "datefmt": "%Y-%m-%dT%H:%M:%S.%f%z",
        },
    },
    "filters": {
        "request": {
            "()": "utility.logging.filters.RequestLogFilter",
        },
    },
    "handlers": {
        "console": {
        ...
        "file": {
            ...
            "filename": "/tmp/audit.log",  # '/tmp/audit.log'
            "formatter": "request",
            "filters": ["request"],
        },
    },
    "loggers": {
        "audit": {"handlers": ["file"], "level": "INFO", "propagate": True},
    },
    "root": {
        "handlers": ["console"],
        "level": "INFO",
